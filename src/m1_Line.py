...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.clonecount = 0
        self.resetstart = start.clone()
        self.resetend = end.clone()
    ...
    def clone(self):
        ...
        clonestart = self.start.clone()

        #clonestart = Point.clone(self.start)
        cloneend = self.end.clone()
        self.clonecount = self.clonecount +1
        return Line(clonestart, cloneend)
    ...
    def line_plus(self, other_line):
        ...
        P1 = self.start.clone()
        P2 = self.end.clone()
        P3 = other_line.start.clone()
        P4 = other_line.end.clone()
        plus1 = Point(0, 0)
        plus2 = Point(1, 1)
        plus1.x = P1.x + P3.x
        plus1.y = P1.y + P3.y
